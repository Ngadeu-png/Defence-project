...
//     assessment: "",
//     plan: "",
//     doctorId: "68c1b63a98c78f06b9346fd0",
//     appointmentId: "68c56ccb8e96085605defed4",
//   });
//   const handleFileChange = (e) => {
//     setSelectedFile(e.target.files[0]);
//   };
//   const handleSaveRecord = () => {
//     if (!newRecord.name || !newRecord.diagnosis) {
//       alert("Please fill in patient details");
//       return;
//     }
//     alert(" Patient record saved & PDF linked!");
//     setNewRecord({ name: "", age: "", diagnosis: "", prescription: "" });
...
//                 {new Date(state.patient.dob).toLocaleDateString()}
//               </p>
//               <p>
...
//                 {new Date(state.patient.createdAt).toLocaleDateString()}
//               </p>
//             </div>
//           </motion.div>
//         )}
...
const PatientRecord = () => {
  ...
  const [newRecord, setNewRecord] = useState({
    ...
    assessment: "",
    plan: "",
    doctor: "68c40618a2c4634d94821059", // replace with actual doctorId
    appointment: "68c54a17863d849ffb24a8e1", // replace with actual appointmentId
  });
